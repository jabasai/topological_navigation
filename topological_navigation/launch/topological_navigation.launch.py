        ...
        TimerAction(
            ...
            actions=[
                Node(
                    ...
                    output='screen',
                    parameters=[{
                        'coarse_white_extension_m': 4.0,
                        'route_white_extension_m': 2.0,
                        'metric_map_resolution': 1.0,
                        'route_segment_resolution': 0.05,
                        'route_segment_border_width': 0.25,
                        'route_segment_padding': 0.0,
                    }],
                ),
            ],
        ),
